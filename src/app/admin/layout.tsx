                ...
                <div className="flex h-screen w-full relative">
                    ...
                    <aside className={`hidden md:flex flex-col bg-surface-light border-r border-border-light h-full shrink-0 z-20 transition-all duration-300 ${sidebarOpen ? 'w-72' : 'w-26'}`}>
                        ...
                        <div className="flex flex-col gap-1 px-4 py-6 overflow-y-auto grow">
                            {/* <!-- Dashboard --> */}
                            <button onClick={() => router.push('dashboard')} className={`flex items-center gap-3 px-3 py-3 rounded-xl transition-colors group ${isActive('dashboard') ? 'bg-primary-light text-primary' : 'text-slate-500 nav-inactive'} ${!sidebarOpen && 'justify-center'}`} title={!sidebarOpen ? 'Dashboard' : ''}>
                            ...
                            <div>
                                <div className={`flex items-center gap-0 rounded-xl transition-colors group ${isActive('projects') ? 'bg-primary-light' : 'nav-inactive'}`}>
                                    <button onClick={() => router.push('projects')} className={`flex-1 flex items-center gap-3 px-3 py-3 rounded-l-xl transition-colors ${isActive('projects') ? 'text-primary' : 'text-slate-500'} ${!sidebarOpen && 'justify-center'}`} title={!sidebarOpen ? 'Projects' : ''}>
                            ...
                            <div>
                                <div className={`flex items-center gap-0 rounded-xl transition-colors group ${isActive('tasks') ? 'bg-primary-light' : 'nav-inactive'}`}>
                                    <button onClick={() => router.push('tasks')} className={`flex-1 flex items-center gap-3 px-3 py-3 rounded-l-xl transition-colors ${isActive('tasks') ? 'text-primary' : 'text-slate-500'} ${!sidebarOpen && 'justify-center'}`} title={!sidebarOpen ? 'Tasks' : ''}>
                            ...
                            <div>
                                <div className={`flex items-center gap-0 rounded-xl transition-colors group ${isActive('users') ? 'bg-primary-light' : 'nav-inactive'}`}>
                                    <button onClick={() => router.push('users')} className={`flex-1 flex items-center gap-3 px-3 py-3 rounded-l-xl transition-colors ${isActive('users') ? 'text-primary' : 'text-slate-500'} ${!sidebarOpen && 'justify-center'}`} title={!sidebarOpen ? 'Users' : ''}>
                            ...
                            <div>
                                <div className={`flex items-center gap-0 rounded-xl transition-colors group ${isActive('candidates') ? 'bg-primary-light' : 'nav-inactive'}`}>
                                    <button onClick={() => router.push('candidates')} className={`flex-1 flex items-center gap-3 px-3 py-3 rounded-l-xl transition-colors ${isActive('candidates') ? 'text-primary' : 'text-slate-500'} ${!sidebarOpen && 'justify-center'}`} title={!sidebarOpen ? 'Candidates' : ''}>
